            ...
            pintamenu();            
             ...
             switch(opcion){
                 case 1:
                     ...
                     break;
                 /**
                  * En este caso, nos pide ingresar una nómina
                  */
                 case 2:
                     c1.ingresar_nómina();
                     break;
                 /**
                  * En este caso, nos pide introducir la contraseña actual para validar el cambio de contraseña
                  */
                 case 3:
                    ...
                    if (c1.cuentaCliente.validar_contraseña(contraleida)){
                     ...
                     break;
                 /**
                  * Este caso nos permite retirar una cantidad especificada
                  */
                 case 4:
                    ...
                    c1.cuentaCliente.modificar_saldo(retirar);
                     break;
                 /**
                  * en este caso cambiamos la contraseña
                  */
                 case 5:
                     c1.cuentaCliente.modificar_contraseña();
                     break;
                 /**
                  * En este caso salimos del programa
                  */
                 case 6:
                     salir=true;
                     break;
